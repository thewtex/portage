...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/imagemagick/imagemagick-6.4.8.3.ebuild,v 1.3 2009/02/08 16:09:25 klausman Exp $
...
IUSE="+bzip2 +corefonts djvu doc fontconfig fpx graphviz gs hdri jbig +jpeg jpeg2k
	+lcms nocxx openexr openmp perl +png q8 q32 raw svg +tiff truetype X wmf
	+xml +zlib"
