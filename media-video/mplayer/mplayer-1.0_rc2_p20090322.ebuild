...
debug dga +dirac directfb doc +dts +dv dvb +dvd +dvdnav dxr3 +enca +encode esd
+faac +faad fbcon +ftp +gif ggi gtk +iconv ipv6 jack joystick +jpeg kernel_linux
ladspa libcaca lirc +live lzo mad +md5sum +mmx mmxext mng +mp2 +mp3 musepack nas
+nemesi +network openal opengl oss +png +pnm pulseaudio pvr +quicktime radio
+rar +real +rtc samba +schroedinger sdl +speex sse sse2 ssse3 svga
