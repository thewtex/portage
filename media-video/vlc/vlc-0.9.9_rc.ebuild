...
# $Header: /var/cvsroot/gentoo-x86/media-video/vlc/vlc-0.9.9_rc.ebuild,v 1.1 2009/02/27 10:46:41 aballier Exp $
...
IUSE="+a52 +aac aalib alsa altivec arts atmo avahi bidi cdda cddax cddb cdio dbus dc1394
	...
	id3tag jack kate libass libcaca +libgcrypt libnotify libsysfs libv4l2 lirc
	+live lua +matroska mmx modplug +mp3 +mpeg musepack ncurses nsplugin ogg opengl optimisememory oss pda +png pulseaudio pvr -qt4
	remoteosd +rtsp run-as-root samba schroedinger sdl sdl-image seamonkey +shout skins speex sse +stream svg svga taglib
	+theora truetype twolame upnp v4l v4l2 vcdinfo vcdx vlm +vorbis win32codecs X x+264 xinerama xml xosd xv zvbi"
